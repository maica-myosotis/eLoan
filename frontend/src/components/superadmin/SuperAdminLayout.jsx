...
export default function SuperAdminLayout() {
  ...
  const fetchUnreadCount = async () => {
    try {
      const data = await superadminService.getUnreadCount();
  ...
  const navItems = [
    { path: '/superadmin/dashboard', icon: 'grid', label: 'Dashboard' },
    { path: '/superadmin/staff', icon: 'users', label: 'Staff Approvals' },
    { path: '/superadmin/members', icon: 'person', label: 'Members' },
    { path: '/superadmin/violations', icon: 'alert', label: 'Violations' },
    { path: '/superadmin/disciplinary', icon: 'gavel', label: 'Disciplinary' },
    { path: '/superadmin/notifications', icon: 'bell', label: 'Notifications', badge: unreadCount },
...
function Icon({ name }) {
  const icons = {
    ...
    'person':  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>,
    ...
    'gavel':   <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M14 3L21 10L13 18L6 11Z"/><line x1="3" y1="21" x2="9" y2="15"/><line x1="14" y1="14" x2="20" y2="8"/></svg>,
    ...
    'log-out': <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/></svg>,
